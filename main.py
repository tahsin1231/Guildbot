...
[FFD700]✨ কেউ GUILD BOT কিনতে চাইলে telegram এ message করবেন, telegram username @rxapon ❤️  
[FF0000]╚══════════╝
[FFD700]✨ Developer —͟͞͞ </> APON GMAING 71❄️  ⚡
"""
...
[00FFFA]║
[FFFF00]║ 👤 Developer    :: [FF1493]APON GMAING 71 
...
# IMPROVED TREE-STYLE HELP MENU SYSTEM (Commands in their original menus) 🌳
                        if inPuTMsG.strip().lower() in ("help", "/help", "menu", "/menu", "commands"):
                            ...
                            # Header
                            header = f"[b][c]{get_random_color()}Hey User Welcome To FLASH FF's BOT"
...
async def MaiiiinE():
    Uid , Pw = '4513872429','7710EC0D592B13CD33622886ADDF606643B13A428B97ED153491DF7F75928257'
